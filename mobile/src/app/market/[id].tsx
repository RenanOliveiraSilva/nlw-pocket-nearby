...
export default function Market() {
    ...
    async function handleOpenCamera() {
        try {
            ...
            if(!granted){
                return Alert.alert('Câmera', 'Você precisa permitir o acesso a câmera para ler o QR Code');
            }
    ...
    async function getCoupon(id: string) {
        try{
            ...
            console.error(error);
            Alert.alert('Error', 'Não foi possível obter o cupom');
        } finally {
    ...
    return (
        <View style={{ flex: 1 }}>
           <StatusBar barStyle={"light-content"} hidden={isVisibleCameraModal} backgroundColor="transparent" translucent={true} />
